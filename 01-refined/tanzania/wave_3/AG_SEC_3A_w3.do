...
* open log
	cap		log		close
	log				using 	"$logout/AG_SEC_3A_w3", append
...
* gen deju var
	rename			ag3a_28 tenure
	gen				deju1 = defa1 if tenure != 11 & tenure != .
	gen				deju2 = defa2 if tenure != 11 & tenure != .
...
* save file
	qui:			compress
	isid			hhid plotnum
	save			"$export/AG_SEC_3A_w3", replace

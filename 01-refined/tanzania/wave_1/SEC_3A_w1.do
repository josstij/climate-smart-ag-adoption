...
* open log
	cap		log		close
	log				using 	"$logout/SEC_3A_w1", append


************************************************************************
**# 1 - clean data for SEC_3A
************************************************************************
...
* gen defa var
	rename			s3aq27_1 defa1
	rename			s3aq27_2 defa2

* gen deju var
	rename			s3aq26 tenure
	gen				deju1 = defa1 if s3aq25 == 1
	gen				deju2 = defa2 if s3aq25 == 1

* gen manager var
	rename			s3aq6_1 mgmt1
	rename			s3aq6_2 mgmt2
	rename			s3aq6_3 mgmt3

...
* does
	* inputs wave3 dataset for indv edu data
...
* define paths
	global	root 	"$data/raw_lsms_data/ethiopia/wave_3/raw/All_others/Household"
...
* open log 
	cap		log		close
	log		using	"$logout/sect2_hh_w3", append
...
* keep essential variables
	keep		individual_id household_id ea_id ea_id2 ///
					admin_1 admin_2 admin_3 admin_4 admin_5 admin_6 ea ///
...
* save file
	...
	save 			"$export/sect2_hh_w3", replace

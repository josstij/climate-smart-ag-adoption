...
* Created on: oct 2025
* Created by: jt
* Edited on: 5 dec 2025
* Edited by: jt
* Stata v.19.5

* does
	* inputs wave2 dataset for post planting field mgmt data
...
* keep essential variables
 	keep		holder_id household_id household_id2 parcel_id field_id mgmt*
...
* save file
	...
	save 			"$export/sect3_pp_w2", replace

...
* create potential tenure-security barrier
	...
	replace		insecure_tenure = 1 if inlist(tenure, 3, 4, 5)
...
* keep essential variables
	keep		holder_id household_id household_id2 ea_id ea_id2 ///
				parcel_id mgmt1 tenure collat defa1 defa2 ///
				title no_title insecure_tenure no_transfer_right ///
				deju1 deju2

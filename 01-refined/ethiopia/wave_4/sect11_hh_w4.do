...
* open log 
	cap		log		close
	log		using	"$logout/sect11_hh_w4", append
...
* inspect Wave 4 asset codes and ownership responses
	codebook	asset_cd s11q00 s11q01

	tab			asset_cd, missing
	
* inspect Wave 4 mobile-phone module
	use			"$root/sect11b1_hh_w4", clear
...
* save household mobile indicator
	qui:		compress
	save		"$export/sect11b1_hh_w4", replace
...
* save file
	qui:		compress
	isid		household_id
	save		"$export/sect11_hh_w4", replace

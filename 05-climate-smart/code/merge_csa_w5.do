...
* does
	* inputs cleaned Wave 5 Section 3 and Section 4 CSA files
	* merges field-level CSA indicators
	* constructs Wave 5 CSA adoption outcomes
	* outputs Wave 5 CSA dataset
...
* define paths
	global	root		"$clean_data/ethiopia/wave_5"
	global	export		"$clean_data/ethiopia/wave_5"
	global	logout		"$cs_logs"
	
* open log
	cap		log			close
	log		using		"$logout/merge_csa_w5", append
...
* save Wave 5 CSA data
	save		"$export/csa_w5", replace

...
* does
	* inputs wave3 dataset for post planting parcel csa data
...
* define paths
	global	root		"$raw_data/ethiopia/wave_3/raw"
	global	export		"$clean_data/ethiopia/wave_3"
	global	logout		"$cs_logs"

* create export folder
	cap		mkdir		"$clean_data/ethiopia/wave_3"
...
* irrigation
	gen			csa_irr = .
	replace		csa_irr = 1 if pp_s3q12 == 1
	replace		csa_irr = 0 if pp_s3q12 == 2
	
* manure
	gen			csa_man = .
	replace		csa_man = 1 if pp_s3q21 == 1
	replace		csa_man = 0 if pp_s3q21 == 2
	
* compost
	gen			csa_comp = .
	replace		csa_comp = 1 if pp_s3q23 == 1
	replace		csa_comp = 0 if pp_s3q23 == 2
...
* erosion prevention
	gen			csa_cons = .
	replace		csa_cons = 1 if pp_s3q32 == 1
	replace		csa_cons = 0 if pp_s3q32 == 2
...
* save cleaned Section 3 file
	save		"$export/sect3_csa_w3", replace

...
* does
	* inputs wave5 dataset for post planting crop roster csa data
...
* define paths
	global	root		"$raw_data/ethiopia/wave_5/raw"
	global	export		"$clean_data/ethiopia/wave_5"
	global	logout		"$cs_logs"
	
* open log
	cap		log			close
	log		using		"$logout/sect4_pp_w5", append
...
* save cleaned Section 4 file
	save		"$export/sect4_csa_w5", replace

...
* does
	* inputs wave3 dataset for post planting crop roster csa data
...
* open log
	cap		log			close
	log		using		"$logout/sect4_pp_w3", append
...
* load raw Section 4 data
	use			"$root/sect4_pp_w3", clear

* inspect identifiers and seed question
	describe	holder_id parcel_id field_id pp_s4q11

* inspect labeled and numeric response categories
	tab			pp_s4q11, missing
	tab			pp_s4q11, missing nolabel
...
* save cleaned Section 4 file
	save		"$export/sect4_csa_w3", replace

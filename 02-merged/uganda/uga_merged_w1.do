...
* define paths
	global		root	"$data/lsms_gender_data/01-refined_data/uganda/wave_1"
	global		export	"$data/lsms_gender_data/02-merged_data/uganda/wave_1"
	global		logout	"$data/lsms_gender_data/02-merged_data/uganda/logs"
	
* open log 
	cap			log		close
	log			using	"$logout/uganda_merged_w1", append
...
* merge edu	
	merge 1:1 hhid indiv using "$root/2009_GSEC4_w1"
...
* merge labor
	merge 1:1 hhid indiv using "$root/2009_GSEC8_w1"

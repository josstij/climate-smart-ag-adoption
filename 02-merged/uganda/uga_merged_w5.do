...
* define paths
	global		root	"$data/lsms_gender_data/01-refined_data/uganda/wave_5"
	global		export	"$data/lsms_gender_data/02-merged_data/uganda/wave_5"
	global		logout	"$data/lsms_gender_data/02-merged_data/uganda/logs"
	
* open log
	cap			log		close
	log			using	"$logout/uganda_merged_w5", append
...
* merge edu	
	merge 1:1 hhid indiv using "$root/gsec4_W5"
...
* merge labor
	merge 1:1 hhid indiv using "$root/gsec8_W5"
